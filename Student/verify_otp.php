...
<body>
    <div class="card shadow-lg bg-white">
        ...
        <?php if($message): ?>
            <div class="alert alert-danger py-2 small" style="font-size: 0.75rem;">
                <?php echo $message; ?>
            </div>
        <?php endif; ?>
        ...
        <form method="POST">
            ...
            <div class="mt-4">
                <a href="forgot_password.php" class="small text-decoration-none text-muted fw-bold">
                    Didn't get the code? <span style="color: #1e3a8a;">Resend</span>
                </a>
            </div>
        </form>
    </div>
