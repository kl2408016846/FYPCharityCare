    ...
    <div class="card bg-white">
        ...
        <form method="POST">
            <div class="mb-4">
                ...
                <input type="email" name="email" class="form-control rounded-3" placeholder="e.g. example@uptm.edu.my" required>
            </div>
            <button type="submit" name="send_otp" class="btn-send">Send OTP Code</button>
            <div class="text-center mt-3">
                <a href="login.php" class="small text-decoration-none text-muted">Back to Login</a>
            </div>
        </form>
    </div>
</body>
